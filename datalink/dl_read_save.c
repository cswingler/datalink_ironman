...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_DL_Y_TAB_H_INCLUDED
# define YY_DL_Y_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
{
       0,    64,    64,    65,    68,   463,   466,   478,   490,   498,
     507,   514,   521,   529,   537,   548,   553
};
#endif
...
{
  "$end", "error", "$undefined", "NAME", "INTEGER", "STRING", "TIME",
  "DATE", "BAD", "'='", "'\\n'", "','", "$accept", "data", "item", "value", YY_NULLPTR
};
#endif
...
{
      -2,    -7,    -8,     0,    -8,     2,    -8,    -8,     8,     9,
      10,     3,     7,    11,    -1,    -8,    -8,    12,    14,    -8,
      -8,    -8,    15,    13,    16,    19,    17,    18,    20,    -8,
      23,    26,    27,    22,    24,    25,    30,    33,    34,    -8,
      -8,    -8
};
...
{
       0,     0,     5,     0,     2,     0,     1,     3,    16,    15,
       0,     0,     0,     0,     0,     4,    13,    10,     0,     8,
      11,    12,     0,     0,     0,     0,     0,     0,     0,     9,
...
{
       6,     1,     5,     1,    21,    22,     8,     9,     2,    10,
       2,    16,    17,    15,    18,    19,    20,    26,    27,    12,
      13,    14,    28,    23,    29,    24,    25,    33,    30,    31,
      34,    32,    35,    36,    39,    37,    38,    40,    41,     7
};

static const yytype_uint8 yycheck[] =
{
       0,     3,     9,     3,     5,     6,     4,     5,    10,     7,
      10,     4,     5,    10,     7,     4,     5,     4,     5,    11,
      11,    11,     6,    11,     5,    11,    11,     4,    11,    11,
       4,    11,     5,    11,     4,    11,    11,     4,     4,     3
};
...
{
       0,     3,    10,    13,    14,     9,     0,    14,     4,     5,
       7,    15,    11,    11,    11,    10,     4,     5,     7,     4,
       5,     5,     6,    11,    11,    11,     4,     5,     6,     5,
      11,    11,    11,     4,     4,     5,    11,    11,    11,     4,
       4,     4
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 69 "dataread.y" /* yacc.c:1646  */
    {
	int fd;
	char file[1024];
	unsigned char mask;
	...
	case CHRON:
		if (strcmp((yyvsp[-3].string), "chron")) {
			sprintf(buf, "Bad entry, %s = chron.", (yyvsp[-3].string));
			dl_error(buf);
			return(-1);
		}
	...
	case TIMER:
		if (strcmp((yyvsp[-3].string), "timer")) {
			sprintf(buf, "Bad entry, %s = timer.", (yyvsp[-3].string));
			dl_error(buf);
			return(-1);
		}
...
#line 1680 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 468 "dataread.y" /* yacc.c:1646  */
    {
...
#line 1694 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 480 "dataread.y" /* yacc.c:1646  */
    {
				hour=minute=second=repeat=chron=0;
				pos = (yyvsp[-8].integer);
				sscanf((yyvsp[-6].string), "%d:%d:%d", &hour, &minute, &second);
				strcpy(msg, (yyvsp[-4].string));
				repeat = (yyvsp[-2].integer);
				chron = (yyvsp[0].integer);
				(yyval.integer) = TIMER;
			}
#line 1708 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 492 "dataread.y" /* yacc.c:1646  */
    {
				strcpy(msg, (yyvsp[-2].string));
				pos = (yyvsp[0].integer);
				(yyval.integer) = CHRON;
...
#line 1718 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 500 "dataread.y" /* yacc.c:1646  */
    {
...
#line 1730 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 509 "dataread.y" /* yacc.c:1646  */
    {
...
#line 1740 "y.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 516 "dataread.y" /* yacc.c:1646  */
    {
...
#line 1750 "y.tab.c" /* yacc.c:1646  */
  ...
  case 12:
#line 523 "dataread.y" /* yacc.c:1646  */
    {
				month=day=year=0;
...
#line 1761 "y.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 531 "dataread.y" /* yacc.c:1646  */
    {
				chime=beep=0;
...
#line 1772 "y.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 539 "dataread.y" /* yacc.c:1646  */
    {
				minute=tfmt=dfmt;
				pos = (yyvsp[-8].integer);
...
#line 1786 "y.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 549 "dataread.y" /* yacc.c:1646  */
    {
				strcpy(msg, (yyvsp[0].string));
				(yyval.integer) = DATA;
			}
#line 1795 "y.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 554 "dataread.y" /* yacc.c:1646  */
    {
				val = (yyvsp[0].integer);
...
#line 560 "dataread.y" /* yacc.c:1906  */
